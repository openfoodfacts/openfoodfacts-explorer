...
You can test it in the staging environment at [https://beta.openfoodfacts.net](https://beta.openfoodfacts.net) _(HTTP Basic Auth credentials: username `off`, password `off`)_.
