...
>
	...
	>
		<div class="h-full w-2/5 text-center text-sm sm:w-28 lg:w-36">
			...
			{:else}
				<div class="flex h-full w-full items-center justify-center bg-transparent text-black">
					<img
						src="/Placeholder.svg"
		...
		<div
			class="flex w-3/5 flex-col items-center justify-evenly p-2 pl-3 font-semibold sm:w-40 md:w-56 lg:w-52"
		>
			<div
