...
<div class="bg-base-100 min-h-screen">
	...
	<div class="bg-base-200 border-base-300 border-b">
		<div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8">
			...
			<h1 class="text-base-content text-2xl font-bold sm:text-3xl lg:text-4xl">
				Guide for Producers
			</h1>
			<p class="text-base-content/70 mt-3 max-w-2xl text-sm leading-relaxed sm:text-base">
	...
	<div class="mx-auto max-w-7xl px-3 py-4 sm:px-6 sm:py-8 lg:px-8">
		<!-- ── Mobile-only: Table of Contents collapse (below md) ── -->
		<div class="mb-4 lg:hidden">
			<details class="collapse-arrow bg-base-200 border-base-300 collapse rounded-xl border">
				<summary class="collapse-title min-h-0 px-4 py-3 text-sm font-semibold">
					Table of Contents
				</summary>
		...
		<!-- ── Desktop: sidebar + main side-by-side (lg and up) ── -->
		<div class="flex items-start gap-8">
			...
			<!-- Main content -->
			<main class="min-w-0 flex-1 space-y-4 sm:space-y-6">
				<!-- Introduction -->
				<div
					id="introduction"
					...
					<div class="card-body p-4 sm:p-6">
						<div class="mb-1 flex items-center gap-2">
							<svg
								...
								/></svg
							>
							<h2 class="card-title text-base sm:text-lg">Introduction</h2>
						</div>
						<p class="text-base-content/80 text-sm leading-relaxed sm:text-base">
					...
					<div class="card-body p-4 sm:p-6">
						<div class="mb-1 flex items-center gap-2">
							<svg
								...
								/></svg
							>
							<h2 class="card-title text-base sm:text-lg">Why Add Your Product Data?</h2>
						</div>
						<div class="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2">
							{#each [{ icon: '✅', title: 'Complete & accurate', desc: 'Your data is complete, up to date, and without risk of error.' }, { icon: '📸', title: 'Better quality photos', desc: 'Professional photos vs. contributor shots taken in variable conditions.' }, { icon: '📱', title: '100+ applications', desc: 'Your data becomes available in more than 100 downstream apps.' }, { icon: '📊', title: 'Product statistics', desc: 'Get statistics and export your products enriched with Nutri-Score and other indicators.' }] as benefit}
								<div class="bg-base-200 flex gap-3 rounded-xl p-3 sm:p-4">
						...
						<div class="bg-primary/5 border-primary/20 mt-4 rounded-xl border p-3 sm:p-4">
					...
					<div class="card-body p-4 sm:p-6">
						<div class="mb-1 flex items-center gap-2">
							<svg
								...
								/></svg
							>
							<h2 class="card-title text-base sm:text-lg">How to Add Data</h2>
						</div>
						...
						<div class="bg-base-200 mt-3 rounded-xl p-3 sm:p-4">
					...
					<div class="card-body p-4 sm:p-6">
						<div class="mb-1 flex items-center gap-2">
							<svg
								...
								/></svg
							>
							<h2 class="card-title text-base sm:text-lg">Licence</h2>
						</div>
						<div class="mt-2 flex flex-col gap-3 sm:flex-row">
							<div class="bg-base-200 flex-1 rounded-xl p-3 sm:p-4">
					...
					<div class="card-body p-4 sm:p-6">
						<div class="mb-1 flex items-center gap-2">
							<svg
								...
								/></svg
							>
							<h2 class="card-title text-base sm:text-lg">What Data to Send?</h2>
						</div>
						<p class="text-base-content/80 text-sm leading-relaxed">
					...
					<div class="card-body p-4 sm:p-6">
						<div class="mb-1 flex items-center gap-2">
							<svg
								...
								/></svg
							>
							<h2 class="card-title text-base sm:text-lg">Manual Addition</h2>
						</div>
						<p class="text-base-content/80 text-sm leading-relaxed">
					...
					<div class="card-body p-4 sm:p-6">
						<div class="mb-1 flex items-center gap-2">
							<svg
								...
								/></svg
							>
							<h2 class="card-title text-base sm:text-lg">Automated Addition</h2>
						</div>
						<p class="text-base-content/80 text-sm leading-relaxed">
					...
					<div class="card-body p-4 sm:p-6">
						<div class="mb-1 flex items-center gap-2">
							<svg
								...
								/></svg
							>
							<h2 class="card-title text-base sm:text-lg">Picture Format</h2>
						</div>
						...
						<div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
							<div>
								...
								<ul class="text-base-content/70 space-y-1 text-sm">
									...
									<li>• Minimum <strong>300 dpi</strong></li>
									<li>• Flat, unfolded packaging preferred</li>
								</ul>
							</div>
							<div>
					...
					<div class="card-body p-4 sm:p-6">
						<div class="mb-1 flex items-center gap-2">
							<svg
								...
								/></svg
							>
							<h2 class="card-title text-base sm:text-lg">Data Format</h2>
						</div>
								...
								<table class="table-sm table">
									...
									<tbody>
										{#each requiredFields as { field, desc }}
											<tr>
												<td class="align-top"
													><code class="text-primary font-mono text-xs break-all">{field}</code></td
												>
					...
					<div class="card-body p-4 sm:p-6">
						<div class="mb-1 flex items-center gap-2">
							<svg
								...
								/></svg
							>
							<h2 class="card-title text-base sm:text-lg">Sending Photos & Data</h2>
						</div>
						<div class="mt-2 grid grid-cols-1 gap-3 sm:grid-cols-2">
					...
					<div class="card-body p-4 sm:p-6">
						<div class="mb-2 flex items-center gap-2">
							<svg
								...
								/></svg
							>
							<h2 class="card-title text-base sm:text-lg">Frequently Asked Questions</h2>
						</div>
