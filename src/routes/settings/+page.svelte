<script lang="ts">
	...
	const TABS = [
		...
		{ label: 'general', i18nKey: 'settings.tab.general', icon: IconMdiCog },
		{ label: 'editing', i18nKey: 'settings.tab.editing', icon: IconMdiPencil },
		{ label: 'preferences', i18nKey: 'settings.tab.preferences', icon: IconMdiHeart },
		{ label: 'developer', i18nKey: 'settings.tab.developer', icon: IconMdiTools }
	] as const;
...
<div class="min-h-screen bg-base-100">
	<div class="mx-auto max-w-4xl px-4 py-8">
		...
		<div
			...
			class="card bg-base-200 shadow-md"
			class:hidden={activeTab !== 'editing'}
		>
			<div class="card-body">
				<h2 class="card-title flex items-center gap-2">
		...
		<div
			...
			class="card bg-base-200 shadow-md"
			class:hidden={activeTab !== 'preferences'}
		>
			<div class="card-body">
				<h2 class="card-title flex items-center gap-2">
					<IconMdiHeart class="h-6 w-6" />
					{$_('settings.influences', { default: 'Food preferences' })}
				</h2>
